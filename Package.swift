...
let make_pjmedia = MakePackage(
    ...
    c: COptions(
        defines: CDefines(
            noValue: [],
            asZero: ["PJMEDIA_AUDIO_DEV_HAS_PORTAUDIO", "PJMEDIA_AUDIO_DEV_HAS_WMME", "PJMEDIA_HAS_ANDROID_MEDIACODEC", "PJMEDIA_HAS_G7221_CODEC", "PJMEDIA_HAS_G722_CODEC", "PJMEDIA_HAS_FFMPEG_VID_CODEC", "PJMEDIA_HAS_FFMPEG_CODEC_H264", "PJMEDIA_HAS_GSM_CODEC", "PJMEDIA_HAS_ILBC_CODEC", "PJMEDIA_HAS_L16_CODEC", "PJMEDIA_HAS_OPENCORE_AMRNB_CODEC", "PJMEDIA_HAS_OPENCORE_AMRWB_CODEC", "PJMEDIA_HAS_SPEEX_AEC", "PJMEDIA_HAS_SPEEX_CODEC", "PJMEDIA_HAS_WEBRTC_AEC", "PJMEDIA_HAS_WEBRTC_AEC3", "PJ_IS_BIG_ENDIAN"],
            asOne: ["PJMEDIA_AUDIO_DEV_HAS_ALSA", "PJMEDIA_HAS_LIBYUV", "PJMEDIA_HAS_OPENH264_CODEC", "PJMEDIA_HAS_OPUS_CODEC", "PJ_AUTOCONF", "PJ_IS_LITTLE_ENDIAN"],
...
let package = Package(
    ...
    targets: [
        ...
        make_pjmedia.makeTarget(packagePath: ".", buildDir: "pjmedia/build", searchRoot: "pjmedia", publicHeadersPath: "pjmedia/include", dependencies: ["pjlib", "pjlib_util", "srtp", "pjnath", "resample", "yuv"]),
        make_pjmedia_videodev.makeTarget(packagePath: ".", buildDir: "pjmedia/build", searchRoot: "pjmedia", publicHeadersPath: "pjmedia/include", dependencies: ["pjmedia", "yuv"], extraCSettings: [.unsafeFlags(["-fno-objc-arc"])]),
...
let make_pjmedia = MakePackage(
    ...
    c: COptions(
        defines: CDefines(
            ...
            asZero: ["PJMEDIA_AUDIO_DEV_HAS_PORTAUDIO", "PJMEDIA_AUDIO_DEV_HAS_WMME", "PJMEDIA_HAS_ANDROID_MEDIACODEC", "PJMEDIA_HAS_G7221_CODEC", "PJMEDIA_HAS_G722_CODEC", "PJMEDIA_HAS_FFMPEG_VID_CODEC", "PJMEDIA_HAS_FFMPEG_CODEC_H264", "PJMEDIA_HAS_GSM_CODEC", "PJMEDIA_HAS_ILBC_CODEC", "PJMEDIA_HAS_L16_CODEC", "PJMEDIA_HAS_OPENCORE_AMRNB_CODEC", "PJMEDIA_HAS_OPENCORE_AMRWB_CODEC", "PJMEDIA_HAS_SPEEX_AEC", "PJMEDIA_HAS_SPEEX_CODEC", "PJMEDIA_HAS_WEBRTC_AEC", "PJMEDIA_HAS_WEBRTC_AEC3", "PJ_IS_BIG_ENDIAN"],
            asOne: ["PJMEDIA_AUDIO_DEV_HAS_COREAUDIO", "PJMEDIA_HAS_LIBYUV", "PJMEDIA_HAS_OPENH264_CODEC", "PJMEDIA_HAS_OPUS_CODEC", "PJMEDIA_VIDEO_DEV_HAS_DARWIN", "PJMEDIA_VIDEO_DEV_HAS_SDL", "PJ_AUTOCONF", "PJ_IS_LITTLE_ENDIAN"],
            others: [("PJMEDIA_RESAMPLE_IMP", "PJMEDIA_RESAMPLE_LIBRESAMPLE")]
        ),
